...
import com.fisa.yugiohapp.util.Almacenamiento;
...
public class CardsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArchetypeDto archetypeDto = Almacenamiento.loadInMemory(getBaseContext());
        Call<JsonObject> call = apiServiceRest.getCards(archetypeDto.getArchetype_name());
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                try {
                    ...
                    for (Datum d : root.getData()) {
                        if (d.getBanlist_info() == null) {
                            data.add(d);
                        } else {
                            Log.e("erro", "error item on getBanlist_info ");
                        }

                    }
                    // Print information
                    CardsAdaptador adaptador = new CardsAdaptador(getBaseContext(), R.layout.cards_item, data);
