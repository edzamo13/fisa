...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        if (!spinnerMesa.getSelectedItem().toString().isEmpty()) {
            Toast.makeText(MainActivity.this, "You Select letter!.." + archetypeDtos.get(position)  , Toast.LENGTH_SHORT).show();
            Almacenamiento.saveInMemory(archetypeDtos.get(position),getBaseContext());
